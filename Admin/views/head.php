  ...
  <div class="main-container d-flex m-o" >
    ...
    <div class="sidebar" id="side_nav">
      ...
      <ul class="list-unstyled px-3 pt-3 pb-4 ">
        <li class="active"><a href="./head.php" class="text-decoration-none px-2 py-2 d-block">Dashboard</a></li>
        ...
        <hr class="h-color mx-2">
        <li class="oiu"><a href="" class="text-decoration-none px-3 py-2 d-block">Trasfusão</a></li>
        <li class=""><a href="" class="text-decoration-none px-3 py-2 d-block">Pacintes</a></li>
       
      </ul>
      <hr class="h-color mx-2">
      <ul class="list-unstyled px-2">
        <li><a href="./AdicionarFuncionario.php" class="text-decoration-none px-3 py-2 d-block">Novo Funcionario</a></li>
        <li><a href="./Ver_funcionarios.php" class="text-decoration-none px-3 py-2 d-block">Funcionario</a></li>
