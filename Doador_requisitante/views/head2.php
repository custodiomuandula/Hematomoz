...
<body>
    ...
    <nav class="navbar navbar-expand-sm head">
        ...
        <div class="container-fluid">
            <img class="navbar-brand" src="../../Admin/assets/fotos/Imagem.png">
            <h3 class="text-white position-absolute" style="left: 110px;">HEMATOMOZ</h3>
            <!-- Links -->
            <ul class="navbar-nav ">
                <li class="nav-item">
                    <a class="nav-link" href="#">Logout (Custodio)</a>
                </li>
            </ul>
        </div>
        ...
        <div class="container sidebar m-0">
            ...
            <nav class="navbar">
                ...
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link" href="#"><i class="fa-solid fa-hand-holding-heart"></i> Agendar Doacoes</a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link" href=""><i class="fa-solid fa-user-doctor"></i>Doações pendentes</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href=""><i class="fa-solid fa-user-pen"></i>Definição</a>
                        </li>
